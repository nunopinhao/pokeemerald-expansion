...
enum HoennDexOrder
{
    ...
    HOENN_DEX_WOOLOO,
    HOENN_DEX_DUBWOOL,
    HOENN_DEX_ALOLAN_MEOWTH,
    HOENN_DEX_ALOLAN_PERSIAN,
    HOENN_DEX_ODDISH,
    HOENN_DEX_GLOOM,
    HOENN_DEX_VILEPLUME,
    HOENN_DEX_BELLOSSOM,
    ...
    HOENN_DEX_ROCKRUFF,
    HOENN_DEX_LYCANROC,
    HOENN_DEX_HISUIAN_GROWLITHE,
    HOENN_DEX_HISUIAN_ARCANINE,
    HOENN_DEX_SHINX,
    HOENN_DEX_LUXIO,
    HOENN_DEX_LUXRAY,
    HOENN_DEX_MAREEP,
    ...
    HOENN_DEX_SPOINK,
    HOENN_DEX_GRUMPIG,
    HOENN_DEX_TAUROS_COMBAT_BREED,
    HOENN_DEX_TAUROS_BLAZE_BREED,
    HOENN_DEX_TAUROS_AQUA_BREED,
    HOENN_DEX_VANILLITE,
    HOENN_DEX_VANILLISH,
    HOENN_DEX_VANILLUXE,
    HOENN_DEX_KLINK,
