...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(MEOWTH_ALOLA),
    HOENN_TO_NATIONAL(PERSIAN_ALOLA),
    ...
    HOENN_TO_NATIONAL(RAICHU_ALOLA),
    ...
    HOENN_TO_NATIONAL(TAUROS_PALDEA_COMBAT),
