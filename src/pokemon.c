...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(ALOLAN_MEOWTH),
    HOENN_TO_NATIONAL(ALOLAN_PERSIAN),
    ...
    HOENN_TO_NATIONAL(ALOLAN_RAICHU),
    ...
    HOENN_TO_NATIONAL(HISUIAN_GROWLITHE),
    HOENN_TO_NATIONAL(HISUIAN_ARCANINE),
    ...
    HOENN_TO_NATIONAL(TAUROS_COMBAT_BREED),
    HOENN_TO_NATIONAL(TAUROS_BLAZE_BREED),
    HOENN_TO_NATIONAL(TAUROS_AQUA_BREED),
