...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CRISTIN] = REMATCH(TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, MAP_ROUTE121),
    ...
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, MAP_ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, TRAINER_MARGARITA, MAP_ROUTE121),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_1, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_3, MAP_MT_PYRE_3F),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_BLAZE
